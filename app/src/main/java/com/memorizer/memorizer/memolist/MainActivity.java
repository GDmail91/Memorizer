...
public class MainActivity extends AppCompatActivity {
    ...
    private void setLayout() {
        ...
        navigationView.setNavigationItemSelectedListener(mainViewModel.navigationSelectedListener);


        // Float Button
        fab = (FloatingActionButton) findViewById(R.id.fab);
        fab.setOnClickListener(mainViewModel.fabClickListener);


        // 필터 리스트 세팅
        filterList = (Spinner) findViewById(R.id.filter_list);
        filterList.setOnItemSelectedListener(mainViewModel.filterListSelectedListener);

        // RecyclerView Swipe 기능
        swipeRefreshLayout = (SwipeRefreshLayout) findViewById(R.id.swipeRefresh);
        swipeRefreshLayout.setOnRefreshListener(mainViewModel.swipeRefreshListener);
